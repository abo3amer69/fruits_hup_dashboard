...
import 'package:fruits_hup_dashboard/features/add_product/presentation/views/widget/add_product_view_body_bloc_builder.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        ...
        child: const addProductViewBodyBlockBuilder(),
      ),
    );
  }
}
